...
class TransStrings
{
	public static function getStrings()
	{
		return array(
			...
			'DesignYourEmail' => __('Design email', 'mrm'),
			...
			'EditYourTemplate' => __('Edit design', 'mrm'),
			...
			// Unsubscribe Survey
			'UnsubscribeSurvey'                       => __('Unsubscribe Survey', 'mrm'),
			'EnableUnsubscribeSurvey'                 => __('Enable unsubscribe survey', 'mrm'),
			'EnableUnsubscribeSurveyToolTip'          => __('Show a short feedback survey to subscribers after they unsubscribe.', 'mrm'),
			'AllowOtherText'                          => __('Allow "Other" reason text', 'mrm'),
			'AllowOtherTextToolTip'                   => __('Display a text field when a subscriber selects "Other" so they can explain their reason.', 'mrm'),
			'AllowResubscription'                     => __('Allow resubscription link', 'mrm'),
			'AllowResubscriptionToolTip'              => __('Show a "Resubscribe" link on the survey page so subscribers can change their mind.', 'mrm'),
			'UnsubscribeReasons'                      => __('Unsubscribe Reasons', 'mrm'),
			'UnsubscribeReasonLabel'                  => __('Unsubscribe Reason', 'mrm'),
			...
			// rather than reused coupon copy.
			'EddCreateDiscount' => __('Create Discount', 'mrm'),
			'EddCreateADiscount' => __('Create a discount', 'mrm'),
			'EddCreateANewDiscount' => __('Create a new discount code in Easy Digital Downloads', 'mrm'),
			'EddUseThisDiscountOnEmail' => __('Use this dynamic discount in emails:', 'mrm'),
			'EddDiscountName' => __('Discount Name', 'mrm'),
			'EddDiscountNameTooltip' => __('Add a discount name for internal usage only.', 'mrm'),
			'EddDiscountCodePrefix' => __('Discount Code Prefix', 'mrm'),
			'EddDiscountCodePrefixTooltip' => __("Mail Mint generates a unique discount code for each contact by adding a custom prefix. For example, 'SPECIALOFFER92D3AI'.", 'mrm'),
			'EddDiscountTypeTooltip' => __("Choose whether the amount is a percentage or a flat amount. If nothing is selected, a percentage discount is used.", 'mrm'),
			'EddDiscountAmount' => __('Discount Amount', 'mrm'),
			'EddDiscountAmountTooltip' => __('Value of the discount. Easy Digital Downloads rejects a zero amount.', 'mrm'),
			'EddApplyTo' => __('Apply Discount To', 'mrm'),
			'EddApplyToTooltip' => __('Apply the discount to the entire cart, or only to the downloads selected under Usage Restriction.', 'mrm'),
			'EddEntireCart' => __('Entire cart', 'mrm'),
			'EddSelectedDownloads' => __('Only selected downloads', 'mrm'),
			'EddSelectedDownloadsMsg' => __('When restricted to selected downloads, choose them under the Usage Restriction tab.', 'mrm'),
			'EddDiscountExpiryDate' => __('Discount Expiry Date', 'mrm'),
			'EddDiscountExpiryDateTooltip' => __('Set whether the discount expires. Choose a fixed date or a duration (e.g., 10 days after creation).', 'mrm'),
			'SelectExpiryDate' => __('Select expiry date', 'mrm'),
			'EnterNumberOfDays' => __('Enter number of days', 'mrm'),
			'EddMinimumSpendTooltip' => __('The minimum cart subtotal allowed to use this discount.', 'mrm'),
			'EddDownloads' => __('Downloads', 'mrm'),
			'EddDownloadsTooltip' => __('Downloads this discount can be applied to. Leave blank for any.', 'mrm'),
			'EddSearchForDownload' => __('Search for a download', 'mrm'),
			'EddNoDownloadFound' => __('No download found', 'mrm'),
			'EddDownloadCondition' => __('Download Condition', 'mrm'),
			'EddDownloadConditionTooltip' => __('Whether the cart must contain all of the selected downloads, or just one of them.', 'mrm'),
			'EddExcludeDownloads' => __('Exclude Downloads', 'mrm'),
			'EddExcludeDownloadsTooltip' => __('Downloads this discount cannot be applied to. Leave blank for none.', 'mrm'),
			'EddDownloadCategories' => __('Download Categories', 'mrm'),
			'EddDownloadCategoriesTooltip' => __('Download categories this discount applies to, or is excluded from, based on the condition below.', 'mrm'),
			'EddCategoryCondition' => __('Category Condition', 'mrm'),
			'EddCategoryConditionTooltip' => __('Whether the selected categories are the only ones discounted, or the ones excluded from the discount.', 'mrm'),
			'EddRestrictToContactEmailMsg' => __('Check this box to apply the discount exclusively to this contact email. Recommended, so a forwarded email cannot be redeemed by someone else.', 'mrm'),
			'EddUsageLimitPerDiscount' => __('Usage Limit Per Discount', 'mrm'),
			'EddUsageLimitPerDiscountTooltip' => __('How many times this discount can be used before it is void. Leave blank for unlimited.', 'mrm'),
			'EddOncePerCustomer' => __('Limit To One Use Per Customer', 'mrm'),
			'EddOncePerCustomerMsg' => __('Check this box to prevent a customer from using this discount more than once. Easy Digital Downloads has no per-customer count, only this flag.', 'mrm'),
			...
			'ConfirmationType'           => __('What to do after submit', 'mrm'),
			'ConfirmationTypeTooltip'    => __('Choose the type of action after form submission.', 'mrm'),
			'SamePage'                   => __('Show a message', 'mrm'),
			'ToAPage'                    => __('Go to a page', 'mrm'),
			'ToACustomURL'               => __('Redirect to URL', 'mrm'),
			'MessageToShow'              => __('Your confirmation message', 'mrm'),
			'MessageToShowTooltip'       => __('Enter the text you would like the user to see on the confirmation page of this form.', 'mrm'),
			'AfterFormSubmission'        => __('Then do', 'mrm'),
			'AfterFormSubmissionTooltip' => __('Define behaviour of the form after submission', 'mrm'),
			'None'                       => __('None', 'mrm'),
			'HideForm'                   => __('Hide the form', 'mrm'),
			'ResetForm'                  => __('Clear and reset', 'mrm'),
			...
			'RunAutomationMultipleTime' => __('Run automation', 'mrm'),
			...
			'GetNotificationEveryTime' => __('Notify me on new submissions', 'mrm'),
			...
			'IconColor' => __('Close icon color', 'mrm'),
			'BackgroundColor' => __('Colse icon background color', 'mrm'),
			...
			'AnniversaryDescription' => __('Celebrates recurring milestones by engaging contacts on key dates.', 'mrm'),
			...
			'PostPublishDescription'                      => __( 'Runs when a new blog post goes live on your site.', 'mrm' ),
			...
			'ViewInBrowserLink'							  => __('View in Browser', 'mrm'),
			...
			'BounceTracking'						      => __('Bounce Handling', 'mrm'),
