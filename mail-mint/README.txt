...
For any trigger, you can create automation workflows using the **necessary actions** below:
...
* Bugfix: Automation Log table performance issue
...
* Improvement: User Experience on the Form Editor
* Improvement: User Experience on the Automation Editor

= 1.21.3 (2026-04-29) =
* New: Auto-deletes Expired Coupons Generated by Mail Mint (Pro)
* Improvement: Automation Import Skips Conditional Actions and Nested Sub-Actions
* Improvement: Business Profile and Email Sending Settings
* Bugfix: WooCommerce Customer Segmentation Issue
* Bugfix: resolves reCAPTCHA Conflicts when Multiple Forms appear on the Same Page
...
* Improvement: OR Logic Support on the Automation Conditional Node (Pro)
* Improvement: Email Engagement Conditions on the Automation Conditional Node (Pro)
* Improvement: Improve Query Performance on WooCommerce Customer Import
